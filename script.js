    ...
    if (fields[index] === null) {
        ...
        if (isGameFinished()) {
            ...
            if (winCombination) {
                ...
                document.getElementById('player-indicator').innerHTML = `${currentPlayer === 'circle' ? generateCircleSVG() : generateCrossSVG()} hat gewonnen!`;
            } else {
                document.getElementById('player-indicator').innerText = 'Unentschieden!';
            }
            return;
        }
...
function updatePlayerIndicator() {
    ...
    indicator.innerHTML = currentPlayer === 'circle' ? generateCircleSVG() : generateCrossSVG();
}
...
function drawWinningLine(combination) {
  ...
  const lineLength = Math.sqrt(Math.pow(endRect.left - startRect.left, 2) + 
...
function restartGame() {
  ...
  document.getElementById('player-indicator').innerText = currentPlayer === 'circle' ? 'Kreis' : 'Kreuz';
